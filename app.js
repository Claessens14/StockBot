...
var bot = new builder.UniversalBot(connector, function (session) {
  ...
  //console.log(JSON.stringify(session.message, null, 2));
   ...
   var payload = {
      ...
      context: userHolder.context,    //should be no context value when program starts
   ...
   conversation.message(payload, function(err, response) {
      ...
      if (response.output.text != "") {
         ...
         // if (JSON.stringify(userHolder.intents[0].intent, null, 2).localeCompare("Search") == -1) {    //for some reasson they are off by a value of -1
         //   console.log("--------Search----------");
         // }
